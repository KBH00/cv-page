          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground">
                My Research interests are RL, Diffusion, LMM, Scene Graph Generation.
                </p>
      ...
      <footer className="bg-primary text-primary-foreground py-6 px-4 md:px-6">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link href="www.linkedin.com/in/byunghyun-kim-a05452319" className="hover:underline" prefetch={false}>
              LinkedIn
            </Link>
